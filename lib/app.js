...
app.get('/api/v1/users/:id/parcels', function (req, res) {
  var allParcels = parcels;
  var userParcels = allParcels.filter(function (parcel) {
    return parcel.userId === parseInt(req.params.id);
  });
...
app.put('/api/v1/users/:id/cancel', function (req, res) {
